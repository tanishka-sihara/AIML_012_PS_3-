...
🔗 Live App: dashboarddronefootageobjectdetection.streamlit.app 🔗 Dashboard Repo: AIML_012_PS_3_Dashboard
...
└── README.md
Dataset
The VisDrone Dataset is used — a benchmark specifically designed for aerial vision tasks.
...
Parsing and converting VisDrone annotations to YOLO format
Training on both image and video data (Training/)
Evaluation on a held-out test set (Test/)
Inference — standard, SAHI-enhanced, and text-prompt-based (Inference/)
A bonus alert module for restricted zone monitoring (Bonus Features/)
How to Use
Prerequisites
...
Or access the hosted version directly: dashboarddronefootageobjectdetection.streamlit.app
...
Text prompt: "yellow car, black car, white car" Prompt Based Detection

Text prompt on video: "red car" https://github.com/user-attachments/assets/19cacd9e-5dac-47a4-a3a5-29d0c3043a06
